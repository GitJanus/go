...
func (sm3 *sm3Digest) Update(msg []byte, nblocks int) {
	var w [68]uint32
	var w1 [64]uint32

	a, b, c, d, e, f, g, h := sm3.v[0], sm3.v[1], sm3.v[2], sm3.v[3], sm3.v[4], sm3.v[5], sm3.v[6], sm3.v[7]
	for len(msg) >= 64 {
		for i := 0; i < 16; i++ {
	...
	sm3.v[0], sm3.v[1], sm3.v[2], sm3.v[3], sm3.v[4], sm3.v[5], sm3.v[6], sm3.v[7] = a, b, c, d, e, f, g, h
}
